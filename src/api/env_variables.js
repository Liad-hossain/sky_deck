...
// In production: _secrets.js is generated by CI before build (values get bundled).
// In local dev: _secrets.js exports an empty object; use .env + process.env.
...
const GROQ_API_KEY = get('SKY_DECK_GROQ_API_KEY') || get('GROQ_API_KEY');
